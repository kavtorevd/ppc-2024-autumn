...
#include "core/task/include/task.hpp"  // Убедитесь, что путь к заголовку корректный
...
public:
    explicit testTaskSequential(std::shared_ptr<ppc::core::TaskData> taskData_)
        ...
        // Проверка и инициализация входных данных
        ...
        // Копируем входные данные в вектор `data_`
...
private:
    std::vector<int> data_;              // Данные вектора для обработки
    std::pair<int, int> result_;         // Пара наиболее отличающихся соседей
};
